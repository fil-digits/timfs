...
<section class="content">
    ...
    <div class="box box-default">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <form action="{{ route('uploadCostPrice') }}" method="POST" id="sku-legend" role="form" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class='callout callout-success col-md-12'>
                        ...
                        * Blank Supplier Cost and Sales Price will not accept.<br/>
                        * Blank row will not accept.<br/>
                        * Non-numerical Supplier Cost and Sales Price will not accept.<br/>
                        * Please limit your items to "<b style="color:yellow;">2k</b>" records per upload.<br/>
                    </div>
                </div>
                <div class="row">
                    <div class="text-center col-md-4">
                        <a href="{{ route('getPriceTemplate') }}"  style="width: 100%;" class="btn btn-primary" role="button">Download Costing Template</a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box-footer">
                            ...
                            <button class="btn btn-primary pull-right" type="submit" id="btnSubmit"> <i class="fa fa-upload" ></i> Upload Costing</button>
                        </div>

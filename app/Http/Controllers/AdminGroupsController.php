<?php namespace App\Http\Controllers;
	...
	class AdminGroupsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "group_code";
			$this->limit = "20";
			$this->orderby = "group_description,asc";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Group Code','name'=>'group_code','type'=>'text','validation'=>'required|unique:groups|min:3|max:3','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Group Description','name'=>'group_description','type'=>'text','validation'=>'required|unique:groups|min:3|max:30','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Group Short Description','name'=>'group_short_description','type'=>'text','validation'=>'max:15','width'=>'col-sm-4'];
	    ...
	    */
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        if($button_name == 'set_status_ACTIVE') {
				Group::whereIn('id',$id_selected)->update([
					'status'=>'ACTIVE', 

<?php namespace App\Http\Controllers;
	...
	class AdminSubcategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Category','name'=>'categories_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-4','datatable'=>'categories,category_description','datatable_where'=>'status=\'ACTIVE\''];
			$this->form[] = ['label'=>'Subcategory Code','name'=>'subcategory_code','type'=>'text','validation'=>'required|unique:subcategories|min:7|max:15','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Subcategory Description','name'=>'subcategory_description','type'=>'text','validation'=>'required|unique:subcategories|min:5|max:35','width'=>'col-sm-4'];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/subcategory_master.js");

<?php namespace App\Http\Controllers;
	...
	class AdminVendorTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Vendor Type Code','name'=>'vendor_type_code','type'=>'text','validation'=>'required|unique:vendor_types|min:7|max:7','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Vendor Type Description','name'=>'vendor_type_description','type'=>'text','validation'=>'required|unique:vendor_types|min:3|max:30','width'=>'col-sm-4'];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/vendor_type_master.js");

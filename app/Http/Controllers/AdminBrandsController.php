<?php namespace App\Http\Controllers;
	...
	class AdminBrandsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Brand Code','name'=>'brand_code','type'=>'text','validation'=>'required|unique:brands|min:3|max:3','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Brand Description','name'=>'brand_description','type'=>'text','validation'=>'required|unique:brands|min:3|max:30','width'=>'col-sm-4'];

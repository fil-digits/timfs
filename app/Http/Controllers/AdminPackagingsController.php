<?php namespace App\Http\Controllers;
	...
	class AdminPackagingsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "packaging_code";
			$this->limit = "20";
			$this->orderby = "packaging_description,asc";
			...
			$this->table = "packagings";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Packaging Code","name"=>"packaging_code"];
			$this->col[] = ["label"=>"Packaging Description","name"=>"packaging_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Packaging Code','name'=>'packaging_code','type'=>'text','validation'=>'required|unique:packagings|min:3|max:3','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Packaging Description','name'=>'packaging_description','type'=>'text','validation'=>'required|unique:packagings|min:3|max:30','width'=>'col-sm-4'];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/packaging_master.js");
	    ...
	    */
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        if($button_name == 'set_status_ACTIVE') {
				Packaging::whereIn('id',$id_selected)->update([
					'status'=>'ACTIVE', 

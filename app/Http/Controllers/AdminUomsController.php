<?php namespace App\Http\Controllers;
	...
	class AdminUomsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'UOM Code','name'=>'uom_code','type'=>'text','validation'=>'required|unique:uoms|min:1|max:3','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'UOM Description','name'=>'uom_description','type'=>'text','validation'=>'required|unique:uoms|min:3|max:30','width'=>'col-sm-4'];

<?php namespace App\Http\Controllers;
	...
	class AdminFoodCostController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Segment Column Code","name"=>"segment_column_code","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Segment Column Description","name"=>"segment_column_description","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Segment Column Name","name"=>"segment_column_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];

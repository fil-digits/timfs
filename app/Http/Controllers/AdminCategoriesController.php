<?php namespace App\Http\Controllers;
	...
	class AdminCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Category Code','name'=>'category_code','type'=>'text','validation'=>'required|unique:categories|min:3|max:3','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Category Description','name'=>'category_description','type'=>'text','validation'=>'required|unique:categories|min:3|max:30','width'=>'col-sm-4'];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/category_master.js");

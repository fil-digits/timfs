<?php namespace App\Http\Controllers;
	...
	class AdminMenuOldCodeMastersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->limit = "20";
			$this->orderby = "menu_old_code_column_description,asc";
	    ...
	    */
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        if($button_name == 'set_status_ACTIVE') {
				DB::table('menu_old_code_masters')->whereIn('id',$id_selected)->update([
					'status'=>'ACTIVE', 
	    ...
	    */
		...
		public static function createMenuOldCodeColumn($column_name) {
			Schema::table('menu_items', function (Blueprint $table) use ($column_name) {
				$table->string($column_name, 100)->nullable()->after('tasteless_menu_code');
			});

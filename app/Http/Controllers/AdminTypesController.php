<?php namespace App\Http\Controllers;
	...
	class AdminTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "type_description";
			$this->limit = "20";
			$this->orderby = "type_description,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Type Description","name"=>"type_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Type Description','name'=>'type_description','type'=>'text','validation'=>'required|unique:types|min:5|max:30','width'=>'col-sm-4'];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/type_master.js");
	    ...
	    */
	    public function actionButtonSelected($id_selected,$button_name) {
	        ...
	        if($button_name == 'set_status_ACTIVE') {
				Type::whereIn('id',$id_selected)->update([
					'status'=>'ACTIVE', 

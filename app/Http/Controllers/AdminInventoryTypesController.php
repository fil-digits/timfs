<?php namespace App\Http\Controllers;
	...
	class AdminInventoryTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Inventory Type Code','name'=>'inventory_type_code','type'=>'text','validation'=>'required|unique:inventory_types|min:3|max:3','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Inventory Type Description','name'=>'inventory_type_description','type'=>'text','validation'=>'required|unique:inventory_types|min:3|max:30','width'=>'col-sm-4'];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/inventory_type_master.js");

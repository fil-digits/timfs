<?php namespace App\Http\Controllers;
	...
	class AdminMenuTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "menu_type_description";
			$this->limit = "20";
			$this->orderby = "menu_type_description,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Menu Type Description","name"=>"menu_type_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Menu Type Description','name'=>'menu_type_description','type'=>'text','validation'=>'required|min:1|max:50','width'=>'col-sm-4'];

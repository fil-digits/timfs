...
class CreatePriceStatusesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('price_statuses', function (Blueprint $table) {
            $table->increments('id');
            $table->string('price_status_code',5)->nullable();
            $table->string('price_status_description',30)->nullable();

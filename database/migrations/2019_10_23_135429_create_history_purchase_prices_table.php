...
class CreateHistoryPurchasePricesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_purchase_prices', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('history_purchase_prices');
    }
}

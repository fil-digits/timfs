...
class CreateHistoryCurrentSrpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_current_srps', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->decimal('current_srp',16,2);
    ...
    {
        Schema::dropIfExists('history_current_srps');
    }
}

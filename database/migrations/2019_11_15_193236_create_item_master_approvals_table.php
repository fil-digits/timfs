...
class CreateItemMasterApprovalsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('item_master_approvals', function (Blueprint $table) {
            ...
            $table->tinyInteger('segment_any',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_bbd',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_eyb',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_cbl',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_com',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_fmr',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_fwb',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_fzb',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_hmk',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_htw',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_kkd',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_lps',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_lbs',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_mtd',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_ppd',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_pze',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_psn',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_ppr',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_rcf',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_scb',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_sch',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_sdh',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_smk',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_twu',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_tbf',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_tgd',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_wkd',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_wks',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_wmn',false,true)->length(3)->default(0);

            $table->tinyInteger('segment_1',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_2',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_3',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_4',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_5',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_6',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_7',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_8',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_9',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_10',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_11',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_12',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_13',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_14',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_15',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_16',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_17',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_18',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_19',false,true)->length(3)->default(0);
            $table->tinyInteger('segment_20',false,true)->length(3)->default(0);

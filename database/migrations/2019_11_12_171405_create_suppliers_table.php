...
class CreateSuppliersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('suppliers', function (Blueprint $table) {
            ...
            $table->string('phone_number1',20)->nullable(); //active
            $table->string('phone_number2',20)->nullable(); //active
            $table->string('phone_number3',20)->nullable(); //active
            $table->string('fax_number',20)->nullable(); //active
            $table->string('email',30)->nullable(); //active
            $table->string('www',20)->nullable();
            $table->string('contact_name',30)->nullable(); //active
            $table->string('salutation',5)->nullable(); //active
            //2ND
